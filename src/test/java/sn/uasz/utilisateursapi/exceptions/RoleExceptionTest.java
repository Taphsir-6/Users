...
/**
 * Classe de test unitaire pour la classe RoleException.
...
class RoleExceptionTest {
    ...
    /**
     * Teste le constructeur de RoleException avec uniquement un message.
     * Vérifie que le message est bien stocké et que la cause est nulle.
     */
    @Test
    void testMessageConstructor() {
        String message = "Erreur générique liée au rôle";
    ...
    /**
     * Teste le constructeur de RoleException avec un message et une cause.
    ...
    /**
     * Teste le constructeur de RoleException avec uniquement une cause.
    ...
    void testCauseConstructor() {
        ...
        RoleException exception = new RoleException(cause);
